...
class controller_cem_tf(template_controller):
    def __init__(self, seed: int, num_control_inputs: int, cost_function: str, dt: float, mpc_horizon: float, cem_outer_it: int, cem_rollouts: int, predictor_name: str, predictor_intermediate_steps: int, CEM_NET_NAME: str, cem_stdev_min: float, cem_best_k: int, **kwargs):
