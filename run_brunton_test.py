...
from SI_Toolkit.ApplicationSpecificFiles.get_prediction_TF_predictor import get_data_for_gui_TF
from SI_Toolkit.ApplicationSpecificFiles.get_prediction_from_euler import get_prediction_for_testing_gui_from_euler
