...
def create_nn_instance(args=None, nn_name=None, inputs_list=None, outputs_list=None, load_nn=None, path_save=None,
    ...
    # if wash_out_len == 1 and a is not None:
    #     wash_out_len = a.wash_out_len
    # if return_sequence is False and a is not None:
    #     return_sequence = a.return_sequence
    # if stateful is False and a is not None:
    #     stateful = a.stateful
