...
#SBATCH --output=./others/EulerClusterScripts/EulerTerminalOutput/Experiment_16_11_2024_pole_L_0_05_and_m_0_015/slurm-%A_%a.out   # Output file

# Create output and error directories if they do not exist
mkdir -p ./others/EulerClusterScripts/EulerTerminalOutput/Experiment_16_11_2024_pole_L_0_05_and_m_0_015
