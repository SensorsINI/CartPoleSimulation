...
if formatted_index is not None:
    get_files_from = f'Experiment_Recordings/Trial_4/raw_recordings/previous/Experiment-{formatted_index}.csv'
else:
    get_files_from = 'Experiment_Recordings/Trial_4/raw_recordings/previous/'
    # get_files_from = 'Test'


save_files_to = 'Experiment_Recordings/Trial_4/previous/'
