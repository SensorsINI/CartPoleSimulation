...
if formatted_index is not None:
    get_files_from = f'GRU_recordings/previous/Experiment-{formatted_index}.csv'
else:
    get_files_from = 'GRU_recordings/previous/'
    # get_files_from = 'Test'


save_files_to = 'GRU_recordings_processed/previous/'
