...
fake_trajectory_every_min = 25
fake_trajectory_every_max = 60
...
transform_dataset(get_files_from, save_files_to, transformation='add_fake_trajectories',
                  fake_trajectory_every_min=fake_trajectory_every_min,
                  fake_trajectory_every_max=fake_trajectory_every_max,
