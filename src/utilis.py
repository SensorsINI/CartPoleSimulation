...
def pd_plotter_simple(df, x_name=None, y_name=None, idx_range=[0, -1],
...
def pd_plotter_compare_1(d_ground, df, x_name=None, y_name=None, idx_range=[0, -1],
                      color='blue', dt=None, marker=None, vline=None, title=''):
...
def pd_plotter_compare_2(d_ground, dfs, names, x_name=None, y_name=None, idx_range=[0, -1],
                      colors=['blue', 'green'], dt=None, marker=None, vline=None, title=''):
