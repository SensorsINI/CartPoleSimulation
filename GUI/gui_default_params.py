...
controller_update_interval = 0.01  # s, sets how often the control input should be calculated
...
save_interval = 0.01  # s, How often to save the results of simulation
