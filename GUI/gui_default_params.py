...
dt_simulation = 0.0005  # s, time step of CartPole simulation if run through GUI
controller_update_interval = 0.005  # s, sets how often the control input should be calculated
...
save_interval = 0.005  # s, How often to save the results of simulation
